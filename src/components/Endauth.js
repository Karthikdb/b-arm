...
class Endauth extends React.Component {
  render() {
    return <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
    <div
    ...
    >
      <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        ...
        <div style={{"position":"sticky","top":"32%"}} class="mt-12 flex flex-col items-center">
